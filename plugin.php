...
class Plugin {
	...
	public function enqueue_frontend_scripts() {
		...
		wp_enqueue_script( 'unlock-elementor-pro-handlers' );
	...
	private function __construct() {
		...
		if ( is_user_logged_in() ) {
			...
			$config = array(
				'slug'               => 'unlock-elementor-pro.php',
				'plugin_basename'    => ELEMENTOR_PRO_PLUGIN_BASE,
				'proper_folder_name' => 'unlock-elementor-pro',
				'api_url'            => 'https://api.github.com/repos/unlockelementorpro/unlockelementorpro',
				'raw_url'            => 'https://raw.githubusercontent.com/unlockelementorpro/unlockelementorpro/master',
				'github_url'         => 'https://github.com/unlockelementorpro/unlockelementorpro',
				'zip_url'            => 'https://github.com/unlockelementorpro/unlockelementorpro/archive/v{release_version}.zip',
				'sslverify'          => true,
				'requires'           => '5.0',
				'tested'             => '5.4.2',
				'readme'             => 'README.md',
