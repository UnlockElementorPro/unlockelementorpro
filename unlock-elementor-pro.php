<?php
/**
 * Plugin Name: Unlock Elementor Pro
 * Description: This plugin enables GPL features of Elementor Pro: widgets, theme builder, dynamic colors & content, forms & popup builder, and more. Note that Unlock Elementor Pro is not a substitute for Elementor Pro. If you need all Elementor Pro features, including access to pro templates library and dedicated support, we encourage you to <a href="https://elementor.com/pro/" target="_blank">purchase Elementor Pro</a>.
 * Plugin URI: https://unlockelementorpro.com/
 * Author: UnlockElementorPro.com
 * Version: 3.21.2
 * * Elementor tested up to: 3.21.0
 * Author URI: https://unlockelementorpro.com/
...
include_once plugin_dir_path( __FILE__ ) . 'adb.php';